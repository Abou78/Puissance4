var IA = {
    ...
    getPoidsBase : function (ligne,colonne){
        ...
        switch (colonne){
            case 0 : poidColonne = 1;
                break;
            case 1 : poidColonne = 2;
                break;
            case 2 : poidColonne = 3;
                break;
            case 3 : poidColonne = 3;
                break
            case 4 : poidColonne = 3;
                break;
            case 5 : poidColonne = 2;
                break;
            case 6 : poidColonne = 1;
                break;
        }
        return poidColonne * poidsLigne;
    },
